...
export function About() {
  ...
  return (
    <section className="bg-[#ffffff] py-8">
      <div className="space-y-8 px-10 md:px-80">
        {blocks.map((block, index) => (
          ...
          >
            ...
            {/* Texto com múltiplos parágrafos animados ao scroll */}
            <div className="text-black md:w-7/12 font-[var(--font-bebas-neue)] text-lg space-y-4">
              {block.texts.map((t, i) => (
                <motion.div
                  ...
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true, amount: 0.3 }} // dispara quando 30% do elemento aparece na tela
                >
